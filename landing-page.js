(function(){
  function addStyles(){
    ...
    style.textContent=`
      ...
      .landing-hero{background:linear-gradient(135deg,rgba(11,3,34,.96),rgba(36,7,75,.94));border:1px solid rgba(169,76,255,.35);box-shadow:0 0 42px rgba(124,58,237,.22),inset 0 0 80px rgba(0,0,0,.34);border-radius:24px;padding:48px 28px 28px;text-align:center;overflow:hidden;position:relative;animation:sccyberTVBoxFlicker 4.8s infinite steps(1,end),sccyberTVBoxDrift 9s infinite ease-in-out;}
      .landing-hero:before{content:'';position:absolute;inset:-2px;background:radial-gradient(circle at 20% 20%,rgba(89,255,157,.18),transparent 28%),radial-gradient(circle at 80% 20%,rgba(169,76,255,.22),transparent 30%),repeating-linear-gradient(0deg,rgba(255,255,255,.045) 0 1px,transparent 1px 5px);pointer-events:none;animation:sccyberTVScanMove 5.5s linear infinite;}
      .landing-hero:after{content:'';position:absolute;inset:0;pointer-events:none;background:radial-gradient(ellipse at center,transparent 48%,rgba(0,0,0,.22) 78%,rgba(0,0,0,.45) 100%),linear-gradient(90deg,transparent 0%,rgba(89,255,157,.07) 48%,rgba(169,76,255,.08) 52%,transparent 100%);mix-blend-mode:screen;opacity:.38;animation:sccyberTVGlowPulse 3.8s infinite ease-in-out;}
      @keyframes sccyberTVBoxFlicker{0%,100%{filter:brightness(1) contrast(1.02)}8%{filter:brightness(1.08) contrast(1.12)}9%{filter:brightness(.88) contrast(1.35)}10%{filter:brightness(1.12) contrast(1.06)}42%{filter:brightness(1) contrast(1.02)}43%{filter:brightness(1.18) contrast(1.18)}44%{filter:brightness(.92) contrast(1.28)}68%{filter:brightness(1.04) contrast(1.05)}69%{filter:brightness(.86) contrast(1.3)}70%{filter:brightness(1.08) contrast(1.08)}}
      @keyframes sccyberTVBoxDrift{0%,100%{transform:translate(0,0) skewX(0deg)}34%{transform:translate(.3px,-.2px) skewX(.04deg)}67%{transform:translate(-.3px,.2px) skewX(-.04deg)}}
      @keyframes sccyberTVScanMove{from{background-position:0 0,0 0,0 0}to{background-position:0 0,0 0,0 42px}}
      @keyframes sccyberTVGlowPulse{0%,100%{opacity:.28}45%{opacity:.46}48%{opacity:.22}52%{opacity:.5}}
