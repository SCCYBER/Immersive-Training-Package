...
function loadCompanyButtons(){if(document.getElementById('companyButtonsScript'))return;var s=document.createElement('script');s.id='companyButtonsScript';s.src='admin-company-buttons.js?v=20260624b';document.body.appendChild(s)}
